...
driver_standings_path = join(INPUT_CSV_DIR, 'driver_standings.csv')
constructor_standings_path = join(INPUT_CSV_DIR, 'constructor_standings.csv')
...
standings_df.to_csv(join(OUTPUT_CSV_DIR, 'standings.csv'), index=False)